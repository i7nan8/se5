...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    private CordovaInterface f31cordova;
    ...
    public void init(CordovaInterface cordovaInterface, List<PluginEntry> list, CordovaPreferences cordovaPreferences) {
        if (this.f31cordova == null) {
            this.f31cordova = cordovaInterface;
            this.preferences = cordovaPreferences;
            this.pluginManager = new PluginManager(this, this.f31cordova, list);
        ...
        final AnonymousClass2 r5 = new Runnable() {
            ...
            public void run() {
                ...
                if (CordovaWebViewImpl.this.loadUrlTimeout == i) {
                    CordovaWebViewImpl.this.f31cordova.getActivity().runOnUiThread(r0);
                }
            }
        };
        this.f31cordova.getActivity().runOnUiThread(new Runnable() {
            /* class org.apache.cordova.CordovaWebViewImpl.AnonymousClass3 */

            public void run() {
                if (integer > 0) {
                    CordovaWebViewImpl.this.f31cordova.getThreadPool().execute(r5);
                }
    ...
    public void showWebPage(String str, boolean z, boolean z2, Map<String, Object> map) {
        ...
        if (!z) {
            ...
            try {
                ...
                this.f31cordova.getActivity().startActivity(intent);
            ...
            if (CordovaWebViewImpl.this.engine.getView().getVisibility() != 0) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Thread.sleep(2000);
                            CordovaWebViewImpl.this.f31cordova.getActivity().runOnUiThread(new Runnable() {
